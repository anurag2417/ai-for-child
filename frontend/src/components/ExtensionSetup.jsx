  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-slate-900 rounded-3xl shadow-[0_12px_35px_rgb(0,0,0,0.45)] border border-slate-700 p-8 md:p-12">
          {/* Step 1: Introduction */}
          {step === 1 && (
            <div className="text-center">
              ...
              <div className="bg-slate-800 rounded-2xl p-6 mb-8 border border-slate-700">
                <h3 className="font-semibold text-slate-100 mb-4">What does the extension do?</h3>
                <div className="grid md:grid-cols-3 gap-4 text-sm">
                  <div className="bg-slate-900 rounded-xl p-4 border border-slate-700">
                    <div className="w-10 h-10 bg-sky-900/40 rounded-lg mx-auto mb-2 flex items-center justify-center">
                      <Chrome className="w-5 h-5 text-sky-600" />
                    </div>
                    <p className="text-slate-300">Monitors search queries on Google, Bing, YouTube & more</p>
                  </div>
                  <div className="bg-slate-900 rounded-xl p-4 border border-slate-700">
                    <div className="w-10 h-10 bg-emerald-900/40 rounded-lg mx-auto mb-2 flex items-center justify-center">
                      <AlertCircle className="w-5 h-5 text-emerald-600" />
                    </div>
                    <p className="text-slate-300">Detects inappropriate content and alerts you instantly</p>
                  </div>
                  <div className="bg-slate-900 rounded-xl p-4 border border-slate-700">
                    <div className="w-10 h-10 bg-purple-900/40 rounded-lg mx-auto mb-2 flex items-center justify-center">
          ...
          {step === 2 && (
            <div className="text-center">
              ...
              <div className="text-left bg-slate-800 rounded-2xl p-6 mb-8 border border-slate-700">
                <ol className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-slate-100">Download the Extension</p>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-slate-100">Open Chrome Extensions</p>
                      <p className="text-sm text-slate-400">Go to <code className="bg-slate-900 px-2 py-1 rounded text-sky-400">chrome://extensions</code> in your browser</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-slate-100">Enable Developer Mode</p>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-slate-100">Load the Extension</p>
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  disabled={checking}
                  className="w-full bg-slate-800 text-slate-100 py-4 px-6 rounded-xl font-semibold text-lg hover:bg-slate-700 transition-all flex items-center justify-center gap-2 border border-slate-700"
                >
                  {checking ? (
                    <>
          ...
          {step === 3 && (
            <div className="text-center">
              ...
              <div className="space-y-3">
                ...
                <button
                  onClick={() => setStep(2)}
                  className="w-full bg-slate-800 text-slate-100 py-4 px-6 rounded-xl font-semibold text-lg hover:bg-slate-700 transition-all border border-slate-700"
                >
